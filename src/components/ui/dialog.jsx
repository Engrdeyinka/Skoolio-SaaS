...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        // Mobile-safe sizing:
        //   - w-[calc(100%-2rem)] keeps a 1rem margin on each side on phones
        //   - max-w-lg caps width on desktop (unchanged behaviour)
        //   - max-h-[calc(100dvh-2rem)] + overflow-y-auto lets long forms scroll
